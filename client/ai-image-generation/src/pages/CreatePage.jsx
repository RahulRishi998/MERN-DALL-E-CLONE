...
const CreatePage = () => {
  ...
  const generateImage = async () => {
    if (form.prompt) {
      try {
        setGeneratingImg(true);
        const response = await fetch('http://localhost:8080/api/v1/dalleroute', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const handleSubmit = async (e) =>{
    ...
    if(form.prompt && form.photo){
      ...
      alert('Please enter a prompt and gererate a image')
    }
  }
  ...
  return (
    ...
    <div>
      ...
      <p className='mt-2 text-[#666e75] text-[14px] max-w[500px]'>Browser through a collection of imagination and visually stunning images generated by DALL-E-AI</p>
    </div>
    ...
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit} >
      <div className='flex flex-col gap-5'>
        ...
        <FormField labelName='Prompt' type='text' name='prompt' placeholder=' I Know Your Name' value={form.prompt} handleChange={handleChange} isSurpriseMe handleSurpriseMe={handleSurpriseMe} />
        <div className="relative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center">
            {
              form.photo ? (
                <img src={form.photo} alt={form.prompt} className='w-full h-full object-contain' />
              ) : (
                <img src={previewImg} alt="preview" className='w-9/12 h-9/12 object-contain opacity-40' />
              )
            }
